...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackHawkPublicApi.FeatureFeature();
  });
  ...
  describe('FeatureFeature', function() {
    it('should create an instance of FeatureFeature', function() {
      // uncomment below and update the code to test FeatureFeature
      //var instane = new StackHawkPublicApi.FeatureFeature();
      //expect(instance).to.be.a(StackHawkPublicApi.FeatureFeature);
    });

    it('should have the property enabled (base name: "enabled")', function() {
      // uncomment below and update the code to test the property enabled
      //var instance = new StackHawkPublicApi.FeatureFeature();
