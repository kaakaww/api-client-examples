...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackHawkPublicApi.ApplicationEnvironment();
  });
  ...
  describe('ApplicationEnvironment', function() {
    it('should create an instance of ApplicationEnvironment', function() {
      // uncomment below and update the code to test ApplicationEnvironment
      //var instane = new StackHawkPublicApi.ApplicationEnvironment();
      //expect(instance).to.be.a(StackHawkPublicApi.ApplicationEnvironment);
    });

    it('should have the property currentScanSummary (base name: "currentScanSummary")', function() {
      // uncomment below and update the code to test the property currentScanSummary
      //var instance = new StackHawkPublicApi.ApplicationEnvironment();
    ...
    it('should have the property scanSummaries (base name: "scanSummaries")', function() {
      // uncomment below and update the code to test the property scanSummaries
      //var instance = new StackHawkPublicApi.ApplicationEnvironment();
      //expect(instance).to.be();
    });
