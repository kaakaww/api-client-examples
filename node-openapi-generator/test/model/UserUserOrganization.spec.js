...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackHawkPublicApi.UserUserOrganization();
  });
  ...
  describe('UserUserOrganization', function() {
    it('should create an instance of UserUserOrganization', function() {
      // uncomment below and update the code to test UserUserOrganization
      //var instane = new StackHawkPublicApi.UserUserOrganization();
      //expect(instance).to.be.a(StackHawkPublicApi.UserUserOrganization);
    });

    it('should have the property features (base name: "features")', function() {
      // uncomment below and update the code to test the property features
      //var instance = new StackHawkPublicApi.UserUserOrganization();
