...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackHawkPublicApi.UserUserExternal();
  });
  ...
  describe('UserUserExternal', function() {
    it('should create an instance of UserUserExternal', function() {
      // uncomment below and update the code to test UserUserExternal
      //var instane = new StackHawkPublicApi.UserUserExternal();
      //expect(instance).to.be.a(StackHawkPublicApi.UserUserExternal);
    });
    ...
    it('should have the property applicationIds (base name: "applicationIds")', function() {
      ...
      //var instance = new StackHawkPublicApi.UserUserExternal();
