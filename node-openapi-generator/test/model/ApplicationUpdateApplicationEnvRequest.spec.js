...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackHawkPublicApi.ApplicationUpdateApplicationEnvRequest();
  });
  ...
  describe('ApplicationUpdateApplicationEnvRequest', function() {
    it('should create an instance of ApplicationUpdateApplicationEnvRequest', function() {
      // uncomment below and update the code to test ApplicationUpdateApplicationEnvRequest
      //var instane = new StackHawkPublicApi.ApplicationUpdateApplicationEnvRequest();
      //expect(instance).to.be.a(StackHawkPublicApi.ApplicationUpdateApplicationEnvRequest);
    });
    ...
    it('should have the property applicationId (base name: "applicationId")', function() {
      ...
      //var instance = new StackHawkPublicApi.ApplicationUpdateApplicationEnvRequest();
