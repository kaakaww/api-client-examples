...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackHawkPublicApi.ApplicationNewApplicationRequest();
  });
  ...
  describe('ApplicationNewApplicationRequest', function() {
    it('should create an instance of ApplicationNewApplicationRequest', function() {
      // uncomment below and update the code to test ApplicationNewApplicationRequest
      //var instane = new StackHawkPublicApi.ApplicationNewApplicationRequest();
      //expect(instance).to.be.a(StackHawkPublicApi.ApplicationNewApplicationRequest);
    });
    ...
    it('should have the property dataType (base name: "dataType")', function() {
      ...
      //var instance = new StackHawkPublicApi.ApplicationNewApplicationRequest();
