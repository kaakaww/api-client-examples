...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackHawkPublicApi.UserProviderInfo();
  });
  ...
  describe('UserProviderInfo', function() {
    it('should create an instance of UserProviderInfo', function() {
      // uncomment below and update the code to test UserProviderInfo
      //var instane = new StackHawkPublicApi.UserProviderInfo();
      //expect(instance).to.be.a(StackHawkPublicApi.UserProviderInfo);
    });

    it('should have the property clientId (base name: "clientId")', function() {
      // uncomment below and update the code to test the property clientId
      //var instance = new StackHawkPublicApi.UserProviderInfo();
