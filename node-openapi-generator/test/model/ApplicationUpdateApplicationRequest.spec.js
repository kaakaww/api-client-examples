...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackHawkPublicApi.ApplicationUpdateApplicationRequest();
  });
  ...
  describe('ApplicationUpdateApplicationRequest', function() {
    it('should create an instance of ApplicationUpdateApplicationRequest', function() {
      // uncomment below and update the code to test ApplicationUpdateApplicationRequest
      //var instane = new StackHawkPublicApi.ApplicationUpdateApplicationRequest();
      //expect(instance).to.be.a(StackHawkPublicApi.ApplicationUpdateApplicationRequest);
    });
    ...
    it('should have the property applicationId (base name: "applicationId")', function() {
      ...
      //var instance = new StackHawkPublicApi.ApplicationUpdateApplicationRequest();
