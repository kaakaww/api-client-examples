...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackHawkPublicApi.ApplicationScanSummary();
  });
  ...
  describe('ApplicationScanSummary', function() {
    it('should create an instance of ApplicationScanSummary', function() {
      // uncomment below and update the code to test ApplicationScanSummary
      //var instane = new StackHawkPublicApi.ApplicationScanSummary();
      //expect(instance).to.be.a(StackHawkPublicApi.ApplicationScanSummary);
    });

    it('should have the property alertStats (base name: "alertStats")', function() {
      // uncomment below and update the code to test the property alertStats
      //var instance = new StackHawkPublicApi.ApplicationScanSummary();
      //expect(instance).to.be();
    });

    it('should have the property configHash (base name: "configHash")', function() {
