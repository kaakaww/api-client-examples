...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackHawkPublicApi.UserUserPreferences();
  });
  ...
  describe('UserUserPreferences', function() {
    it('should create an instance of UserUserPreferences', function() {
      // uncomment below and update the code to test UserUserPreferences
      //var instane = new StackHawkPublicApi.UserUserPreferences();
      //expect(instance).to.be.a(StackHawkPublicApi.UserUserPreferences);
    });

    it('should have the property defaultOrganizationId (base name: "defaultOrganizationId")', function() {
      // uncomment below and update the code to test the property defaultOrganizationId
      //var instance = new StackHawkPublicApi.UserUserPreferences();
      //expect(instance).to.be();
    });

    it('should have the property dontReceiveUpdatesEmail (base name: "dontReceiveUpdatesEmail")', function() {
      // uncomment below and update the code to test the property dontReceiveUpdatesEmail
      //var instance = new StackHawkPublicApi.UserUserPreferences();
      //expect(instance).to.be();
    });

    it('should have the property dontReceiveWeeklyEmail (base name: "dontReceiveWeeklyEmail")', function() {
      // uncomment below and update the code to test the property dontReceiveWeeklyEmail
      //var instance = new StackHawkPublicApi.UserUserPreferences();
      //expect(instance).to.be();
    });
