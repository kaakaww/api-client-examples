...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackHawkPublicApi.ApplicationListEnvironmentsResponse();
  });
  ...
  describe('ApplicationListEnvironmentsResponse', function() {
    it('should create an instance of ApplicationListEnvironmentsResponse', function() {
      // uncomment below and update the code to test ApplicationListEnvironmentsResponse
      //var instane = new StackHawkPublicApi.ApplicationListEnvironmentsResponse();
      //expect(instance).to.be.a(StackHawkPublicApi.ApplicationListEnvironmentsResponse);
    });
    ...
    it('should have the property environments (base name: "environments")', function() {
      ...
      //var instance = new StackHawkPublicApi.ApplicationListEnvironmentsResponse();
