...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackHawkPublicApi.ApplicationScanAlertStats();
  });
  ...
  describe('ApplicationScanAlertStats', function() {
    it('should create an instance of ApplicationScanAlertStats', function() {
      // uncomment below and update the code to test ApplicationScanAlertStats
      //var instane = new StackHawkPublicApi.ApplicationScanAlertStats();
      //expect(instance).to.be.a(StackHawkPublicApi.ApplicationScanAlertStats);
    });

    it('should have the property alertStatusStats (base name: "alertStatusStats")', function() {
      // uncomment below and update the code to test the property alertStatusStats
      //var instance = new StackHawkPublicApi.ApplicationScanAlertStats();
      //expect(instance).to.be();
    });

    it('should have the property totalAlerts (base name: "totalAlerts")', function() {
      // uncomment below and update the code to test the property totalAlerts
      //var instance = new StackHawkPublicApi.ApplicationScanAlertStats();
      //expect(instance).to.be();
    });

    it('should have the property uniqueAlerts (base name: "uniqueAlerts")', function() {
      // uncomment below and update the code to test the property uniqueAlerts
      //var instance = new StackHawkPublicApi.ApplicationScanAlertStats();
      //expect(instance).to.be();
    });
