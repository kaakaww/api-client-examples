...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackHawkPublicApi.UserUserResponse();
  });
  ...
  describe('UserUserResponse', function() {
    it('should create an instance of UserUserResponse', function() {
      // uncomment below and update the code to test UserUserResponse
      //var instane = new StackHawkPublicApi.UserUserResponse();
      //expect(instance).to.be.a(StackHawkPublicApi.UserUserResponse);
    });

    it('should have the property unclaimedInviteOrganizationIds (base name: "unclaimedInviteOrganizationIds")', function() {
      // uncomment below and update the code to test the property unclaimedInviteOrganizationIds
      //var instance = new StackHawkPublicApi.UserUserResponse();
