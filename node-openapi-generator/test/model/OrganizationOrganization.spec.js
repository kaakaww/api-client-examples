...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackHawkPublicApi.OrganizationOrganization();
  });
  ...
  describe('OrganizationOrganization', function() {
    it('should create an instance of OrganizationOrganization', function() {
      // uncomment below and update the code to test OrganizationOrganization
      //var instane = new StackHawkPublicApi.OrganizationOrganization();
      //expect(instance).to.be.a(StackHawkPublicApi.OrganizationOrganization);
    });

    it('should have the property features (base name: "features")', function() {
      // uncomment below and update the code to test the property features
      //var instance = new StackHawkPublicApi.OrganizationOrganization();
    ...
    it('should have the property isLinkedToExternalBilling (base name: "isLinkedToExternalBilling")', function() {
      // uncomment below and update the code to test the property isLinkedToExternalBilling
      //var instance = new StackHawkPublicApi.OrganizationOrganization();
      //expect(instance).to.be();
    });
