    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('unclaimedInviteOrganizationIds')) {
                obj['unclaimedInviteOrganizationIds'] = ApiClient.convertToType(data['unclaimedInviteOrganizationIds'], ['String']);
            }
            if (data.hasOwnProperty('user')) {
                obj['user'] = UserUser.constructFromObject(data['user']);
            }
        }
        return obj;
    }
...
export default UserUserResponse;
