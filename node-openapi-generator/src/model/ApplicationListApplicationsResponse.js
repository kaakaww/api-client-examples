...
import ApplicationApplication from './ApplicationApplication';
 ...
 * @version 0.0.1
 */
class ApplicationListApplicationsResponse {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('applications')) {
                obj['applications'] = ApiClient.convertToType(data['applications'], [ApplicationApplication]);
            }
...
export default ApplicationListApplicationsResponse;
