...
import ApplicationAlertStatusStats from './ApplicationAlertStatusStats';
 ...
 * @version 0.0.1
 */
class ApplicationScanAlertStats {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('alertStatusStats')) {
                obj['alertStatusStats'] = ApiClient.convertToType(data['alertStatusStats'], [ApplicationAlertStatusStats]);
            }
            if (data.hasOwnProperty('totalAlerts')) {
                obj['totalAlerts'] = ApiClient.convertToType(data['totalAlerts'], 'Number');
            }
            if (data.hasOwnProperty('uniqueAlerts')) {
                obj['uniqueAlerts'] = ApiClient.convertToType(data['uniqueAlerts'], 'Number');
            }
        }
        return obj;
    }
...
export default ApplicationScanAlertStats;
