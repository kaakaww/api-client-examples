 ...
 * @version 0.0.1
 */
class ApplicationListEnvironmentsResponse {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('environments')) {
                obj['environments'] = ApiClient.convertToType(data['environments'], [ApplicationEnvironment]);
            }
...
export default ApplicationListEnvironmentsResponse;
