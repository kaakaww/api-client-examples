...
import org.openapitools.client.model.ApplicationEnvironment;

/**
 * Paginated response of environments.
 */
@ApiModel(description = "Paginated response of environments.")
...
public class ApplicationListEnvironmentsResponse {
  public static final String SERIALIZED_NAME_ENVIRONMENTS = "environments";
  @SerializedName(SERIALIZED_NAME_ENVIRONMENTS)
  private List<ApplicationEnvironment> environments = null;
  ...
  public ApplicationListEnvironmentsResponse environments(List<ApplicationEnvironment> environments) {
    
    this.environments = environments;
    return this;
  }

  public ApplicationListEnvironmentsResponse addEnvironmentsItem(ApplicationEnvironment environmentsItem) {
    if (this.environments == null) {
      this.environments = new ArrayList<ApplicationEnvironment>();
    }
  ...
  **/
  ...
  @ApiModelProperty(value = "found list of environments.")
  ...
  public ApplicationListEnvironmentsResponse nextPageToken(String nextPageToken) {
  ...
  **/
  ...
  public ApplicationListEnvironmentsResponse totalCount(Long totalCount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApplicationListEnvironmentsResponse applicationListEnvironmentsResponse = (ApplicationListEnvironmentsResponse) o;
    return Objects.equals(this.environments, applicationListEnvironmentsResponse.environments) &&
        Objects.equals(this.nextPageToken, applicationListEnvironmentsResponse.nextPageToken) &&
        Objects.equals(this.totalCount, applicationListEnvironmentsResponse.totalCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(environments, nextPageToken, totalCount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApplicationListEnvironmentsResponse {\n");
