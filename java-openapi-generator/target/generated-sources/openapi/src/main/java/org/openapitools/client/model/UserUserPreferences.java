 ...
 */
@ApiModel(description = "User settings and preferences for interaction within StackHawk")
...
public class UserUserPreferences {
  public static final String SERIALIZED_NAME_DEFAULT_ORGANIZATION_ID = "defaultOrganizationId";
  @SerializedName(SERIALIZED_NAME_DEFAULT_ORGANIZATION_ID)
  private String defaultOrganizationId;

  public static final String SERIALIZED_NAME_DONT_RECEIVE_UPDATES_EMAIL = "dontReceiveUpdatesEmail";
  @SerializedName(SERIALIZED_NAME_DONT_RECEIVE_UPDATES_EMAIL)
  private Boolean dontReceiveUpdatesEmail;

  public static final String SERIALIZED_NAME_DONT_RECEIVE_WEEKLY_EMAIL = "dontReceiveWeeklyEmail";
  @SerializedName(SERIALIZED_NAME_DONT_RECEIVE_WEEKLY_EMAIL)
  private Boolean dontReceiveWeeklyEmail;


  public UserUserPreferences defaultOrganizationId(String defaultOrganizationId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "the UUID identifier of the organization a user currently belongs to")
  ...
  public UserUserPreferences dontReceiveUpdatesEmail(Boolean dontReceiveUpdatesEmail) {
    
    this.dontReceiveUpdatesEmail = dontReceiveUpdatesEmail;
    return this;
  }

   /**
   * if &#x60;true&#x60;, the user will be opted out of Company Update emails
   * @return dontReceiveUpdatesEmail
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "if `true`, the user will be opted out of Company Update emails")

  public Boolean getDontReceiveUpdatesEmail() {
    return dontReceiveUpdatesEmail;
  }


  public void setDontReceiveUpdatesEmail(Boolean dontReceiveUpdatesEmail) {
    this.dontReceiveUpdatesEmail = dontReceiveUpdatesEmail;
  }


  public UserUserPreferences dontReceiveWeeklyEmail(Boolean dontReceiveWeeklyEmail) {
    
    this.dontReceiveWeeklyEmail = dontReceiveWeeklyEmail;
    return this;
  }

   /**
   * if &#x60;true&#x60;, the user will be opted out of weekly organization update emails
   * @return dontReceiveWeeklyEmail
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "if `true`, the user will be opted out of weekly organization update emails")

  public Boolean getDontReceiveWeeklyEmail() {
    return dontReceiveWeeklyEmail;
  }


  public void setDontReceiveWeeklyEmail(Boolean dontReceiveWeeklyEmail) {
    this.dontReceiveWeeklyEmail = dontReceiveWeeklyEmail;
  }
  ...
  public boolean equals(Object o) {
    ...
    UserUserPreferences userUserPreferences = (UserUserPreferences) o;
    return Objects.equals(this.defaultOrganizationId, userUserPreferences.defaultOrganizationId) &&
        Objects.equals(this.dontReceiveUpdatesEmail, userUserPreferences.dontReceiveUpdatesEmail) &&
        Objects.equals(this.dontReceiveWeeklyEmail, userUserPreferences.dontReceiveWeeklyEmail);
  }

  @Override
  public int hashCode() {
    return Objects.hash(defaultOrganizationId, dontReceiveUpdatesEmail, dontReceiveWeeklyEmail);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserUserPreferences {\n");
    sb.append("    defaultOrganizationId: ").append(toIndentedString(defaultOrganizationId)).append("\n");
    sb.append("    dontReceiveUpdatesEmail: ").append(toIndentedString(dontReceiveUpdatesEmail)).append("\n");
    sb.append("    dontReceiveWeeklyEmail: ").append(toIndentedString(dontReceiveWeeklyEmail)).append("\n");
    sb.append("}");
    return sb.toString();
  }
