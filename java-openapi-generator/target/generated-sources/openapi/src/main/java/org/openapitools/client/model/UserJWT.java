 ...
 */
@ApiModel(description = "* A [JSON Web Token](https://jwt.io/) used to authenticate requests to the StackHawk API")
...
public class UserJWT {
  ...
  public UserJWT token(String token) {
  ...
  **/
  ...
  @ApiModelProperty(value = "the bearer token value")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.token, userJWT.token);
  }
