 ...
 */
@ApiModel(description = "Information about a users access Provider to the StackHawk platform")
...
public class UserProviderInfo {
  ...
  public UserProviderInfo clientId(String clientId) {
  ...
  **/
  ...
  public UserProviderInfo created(Long created) {
  ...
  **/
  ...
  public UserProviderInfo slug(SlugEnum slug) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserProviderInfo userProviderInfo = (UserProviderInfo) o;
    return Objects.equals(this.clientId, userProviderInfo.clientId) &&
        Objects.equals(this.created, userProviderInfo.created) &&
        Objects.equals(this.slug, userProviderInfo.slug);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientId, created, slug);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserProviderInfo {\n");
