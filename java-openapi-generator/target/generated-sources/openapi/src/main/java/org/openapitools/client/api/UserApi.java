...
public class UserApi {
     ...
     */
    public UserUserResponse getUser() throws ApiException {
        ApiResponse<UserUserResponse> localVarResp = getUserWithHttpInfo();
     ...
     * Get the current user
     * ## User Details  This endpoint provides details about the requesting user. This information helps determine what access an authorized user has on the StackHawk platform, and how they are authenticated.  
     * @return ApiResponse&lt;UserUserResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<UserUserResponse> getUserWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getUserValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<UserUserResponse>(){}.getType();
     ...
     */
    public okhttp3.Call getUserAsync(final ApiCallback<UserUserResponse> _callback) throws ApiException {
