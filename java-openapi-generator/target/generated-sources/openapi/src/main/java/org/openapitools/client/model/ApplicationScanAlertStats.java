...
import org.openapitools.client.model.ApplicationAlertStatusStats;
...
public class ApplicationScanAlertStats {
  public static final String SERIALIZED_NAME_ALERT_STATUS_STATS = "alertStatusStats";
  @SerializedName(SERIALIZED_NAME_ALERT_STATUS_STATS)
  private List<ApplicationAlertStatusStats> alertStatusStats = null;

  public static final String SERIALIZED_NAME_TOTAL_ALERTS = "totalAlerts";
  @SerializedName(SERIALIZED_NAME_TOTAL_ALERTS)
  private Integer totalAlerts;

  public static final String SERIALIZED_NAME_UNIQUE_ALERTS = "uniqueAlerts";
  @SerializedName(SERIALIZED_NAME_UNIQUE_ALERTS)
  private Integer uniqueAlerts;


  public ApplicationScanAlertStats alertStatusStats(List<ApplicationAlertStatusStats> alertStatusStats) {
    
    this.alertStatusStats = alertStatusStats;
    return this;
  }

  public ApplicationScanAlertStats addAlertStatusStatsItem(ApplicationAlertStatusStats alertStatusStatsItem) {
    if (this.alertStatusStats == null) {
      this.alertStatusStats = new ArrayList<ApplicationAlertStatusStats>();
    }
    this.alertStatusStats.add(alertStatusStatsItem);
    return this;
  }

   /**
   * Get alertStatusStats
   * @return alertStatusStats
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public List<ApplicationAlertStatusStats> getAlertStatusStats() {
    return alertStatusStats;
  }


  public void setAlertStatusStats(List<ApplicationAlertStatusStats> alertStatusStats) {
    this.alertStatusStats = alertStatusStats;
  }


  public ApplicationScanAlertStats totalAlerts(Integer totalAlerts) {
  ...
  **/
  ...
  public ApplicationScanAlertStats uniqueAlerts(Integer uniqueAlerts) {
  ...
  **/
  ...
  public Integer getUniqueAlerts() {
    return uniqueAlerts;
  }


  public void setUniqueAlerts(Integer uniqueAlerts) {
    this.uniqueAlerts = uniqueAlerts;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApplicationScanAlertStats applicationScanAlertStats = (ApplicationScanAlertStats) o;
    return Objects.equals(this.alertStatusStats, applicationScanAlertStats.alertStatusStats) &&
        Objects.equals(this.totalAlerts, applicationScanAlertStats.totalAlerts) &&
        Objects.equals(this.uniqueAlerts, applicationScanAlertStats.uniqueAlerts);
  }

  @Override
  public int hashCode() {
    return Objects.hash(alertStatusStats, totalAlerts, uniqueAlerts);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApplicationScanAlertStats {\n");
    sb.append("    alertStatusStats: ").append(toIndentedString(alertStatusStats)).append("\n");
    sb.append("    totalAlerts: ").append(toIndentedString(totalAlerts)).append("\n");
    sb.append("    uniqueAlerts: ").append(toIndentedString(uniqueAlerts)).append("\n");
    sb.append("}");
    return sb.toString();
  }
