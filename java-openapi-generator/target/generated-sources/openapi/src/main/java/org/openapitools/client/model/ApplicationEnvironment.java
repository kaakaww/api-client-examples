...
import org.openapitools.client.model.ApplicationScanSummary;

/**
 * A decorated application&#39;s environment with details of recent scan stats included.
 */
@ApiModel(description = "A decorated application's environment with details of recent scan stats included.")
...
public class ApplicationEnvironment {
  public static final String SERIALIZED_NAME_CURRENT_SCAN_SUMMARY = "currentScanSummary";
  @SerializedName(SERIALIZED_NAME_CURRENT_SCAN_SUMMARY)
  private ApplicationScanSummary currentScanSummary;
  ...
  public static final String SERIALIZED_NAME_SCAN_SUMMARIES = "scanSummaries";
  @SerializedName(SERIALIZED_NAME_SCAN_SUMMARIES)
  private List<ApplicationScanSummary> scanSummaries = null;


  public ApplicationEnvironment currentScanSummary(ApplicationScanSummary currentScanSummary) {
    
    this.currentScanSummary = currentScanSummary;
    return this;
  }

   /**
   * Get currentScanSummary
   * @return currentScanSummary
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public ApplicationScanSummary getCurrentScanSummary() {
    return currentScanSummary;
  }


  public void setCurrentScanSummary(ApplicationScanSummary currentScanSummary) {
    this.currentScanSummary = currentScanSummary;
  }


  public ApplicationEnvironment environmentId(String environmentId) {
  ...
  **/
  ...
  public ApplicationEnvironment environmentName(String environmentName) {
  ...
  **/
  ...
  public ApplicationEnvironment scanSummaries(List<ApplicationScanSummary> scanSummaries) {
    
    this.scanSummaries = scanSummaries;
    return this;
  }

  public ApplicationEnvironment addScanSummariesItem(ApplicationScanSummary scanSummariesItem) {
    if (this.scanSummaries == null) {
      this.scanSummaries = new ArrayList<ApplicationScanSummary>();
    }
    this.scanSummaries.add(scanSummariesItem);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "summaries of recent scans from this environment.")

  public List<ApplicationScanSummary> getScanSummaries() {
    return scanSummaries;
  }


  public void setScanSummaries(List<ApplicationScanSummary> scanSummaries) {
    this.scanSummaries = scanSummaries;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApplicationEnvironment applicationEnvironment = (ApplicationEnvironment) o;
    return Objects.equals(this.currentScanSummary, applicationEnvironment.currentScanSummary) &&
        Objects.equals(this.environmentId, applicationEnvironment.environmentId) &&
        Objects.equals(this.environmentName, applicationEnvironment.environmentName) &&
        Objects.equals(this.scanSummaries, applicationEnvironment.scanSummaries);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currentScanSummary, environmentId, environmentName, scanSummaries);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApplicationEnvironment {\n");
    sb.append("    currentScanSummary: ").append(toIndentedString(currentScanSummary)).append("\n");
    sb.append("    environmentId: ").append(toIndentedString(environmentId)).append("\n");
    sb.append("    environmentName: ").append(toIndentedString(environmentName)).append("\n");
    sb.append("    scanSummaries: ").append(toIndentedString(scanSummaries)).append("\n");
    sb.append("}");
    return sb.toString();
  }
