...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackHawkPublicApi.ApplicationNewApplicationEnvRequest();
  });
  ...
  describe('ApplicationNewApplicationEnvRequest', function() {
    it('should create an instance of ApplicationNewApplicationEnvRequest', function() {
      // uncomment below and update the code to test ApplicationNewApplicationEnvRequest
      //var instane = new StackHawkPublicApi.ApplicationNewApplicationEnvRequest();
      //expect(instance).to.be.a(StackHawkPublicApi.ApplicationNewApplicationEnvRequest);
    });
    ...
    it('should have the property applicationId (base name: "applicationId")', function() {
      ...
      //var instance = new StackHawkPublicApi.ApplicationNewApplicationEnvRequest();
