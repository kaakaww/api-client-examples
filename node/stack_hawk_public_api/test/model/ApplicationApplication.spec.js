...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackHawkPublicApi.ApplicationApplication();
  });
  ...
  describe('ApplicationApplication', function() {
    it('should create an instance of ApplicationApplication', function() {
      // uncomment below and update the code to test ApplicationApplication
      //var instane = new StackHawkPublicApi.ApplicationApplication();
      //expect(instance).to.be.a(StackHawkPublicApi.ApplicationApplication);
    });
    ...
    it('should have the property applicationId (base name: "applicationId")', function() {
      ...
      //var instance = new StackHawkPublicApi.ApplicationApplication();
