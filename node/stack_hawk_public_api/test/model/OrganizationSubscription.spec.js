...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackHawkPublicApi.OrganizationSubscription();
  });
  ...
  describe('OrganizationSubscription', function() {
    it('should create an instance of OrganizationSubscription', function() {
      // uncomment below and update the code to test OrganizationSubscription
      //var instane = new StackHawkPublicApi.OrganizationSubscription();
      //expect(instance).to.be.a(StackHawkPublicApi.OrganizationSubscription);
    });
    ...
    it('should have the property appCount (base name: "appCount")', function() {
      ...
      //var instance = new StackHawkPublicApi.OrganizationSubscription();
    ...
    it('should have the property recurringIntervalCount (base name: "recurringIntervalCount")', function() {
      // uncomment below and update the code to test the property recurringIntervalCount
      //var instance = new StackHawkPublicApi.OrganizationSubscription();
      //expect(instance).to.be();
    });

    it('should have the property stackhawkOrgId (base name: "stackhawkOrgId")', function() {
      // uncomment below and update the code to test the property stackhawkOrgId
      //var instance = new StackHawkPublicApi.OrganizationSubscription();
      //expect(instance).to.be();
    });
