...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackHawkPublicApi.ApplicationListApplicationsResponse();
  });
  ...
  describe('ApplicationListApplicationsResponse', function() {
    it('should create an instance of ApplicationListApplicationsResponse', function() {
      // uncomment below and update the code to test ApplicationListApplicationsResponse
      //var instane = new StackHawkPublicApi.ApplicationListApplicationsResponse();
      //expect(instance).to.be.a(StackHawkPublicApi.ApplicationListApplicationsResponse);
    });
    ...
    it('should have the property applications (base name: "applications")', function() {
      ...
      //var instance = new StackHawkPublicApi.ApplicationListApplicationsResponse();
