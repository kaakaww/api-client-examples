...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StackHawkPublicApi.ApplicationAlertStatusStats();
  });
  ...
  describe('ApplicationAlertStatusStats', function() {
    it('should create an instance of ApplicationAlertStatusStats', function() {
      // uncomment below and update the code to test ApplicationAlertStatusStats
      //var instane = new StackHawkPublicApi.ApplicationAlertStatusStats();
      //expect(instance).to.be.a(StackHawkPublicApi.ApplicationAlertStatusStats);
    });
    ...
    it('should have the property alertStatus (base name: "alertStatus")', function() {
      ...
      //var instance = new StackHawkPublicApi.ApplicationAlertStatusStats();
      //expect(instance).to.be();
    });

    it('should have the property severityStats (base name: "severityStats")', function() {
      // uncomment below and update the code to test the property severityStats
      //var instance = new StackHawkPublicApi.ApplicationAlertStatusStats();
      //expect(instance).to.be();
    });
