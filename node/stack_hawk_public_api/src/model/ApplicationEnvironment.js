...
import ApplicationScanSummary from './ApplicationScanSummary';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('currentScanSummary')) {
                obj['currentScanSummary'] = ApplicationScanSummary.constructFromObject(data['currentScanSummary']);
            }
            ...
            if (data.hasOwnProperty('scanSummaries')) {
                obj['scanSummaries'] = ApiClient.convertToType(data['scanSummaries'], [ApplicationScanSummary]);
            }
        }
        return obj;
    }
