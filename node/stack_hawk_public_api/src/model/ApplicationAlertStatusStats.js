 ...
 * @version 0.0.1
 */
class ApplicationAlertStatusStats {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('alertStatus')) {
                obj['alertStatus'] = ApiClient.convertToType(data['alertStatus'], 'String');
            }
            if (data.hasOwnProperty('severityStats')) {
                obj['severityStats'] = ApiClient.convertToType(data['severityStats'], {'String': 'Number'});
            }
...
export default ApplicationAlertStatusStats;
