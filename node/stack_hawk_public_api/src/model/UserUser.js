...
import UserUserExternal from './UserUserExternal';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('external')) {
                obj['external'] = UserUserExternal.constructFromObject(data['external']);
            }
            if (data.hasOwnProperty('organizationIds')) {
                obj['organizationIds'] = ApiClient.convertToType(data['organizationIds'], ['String']);
            }
            if (data.hasOwnProperty('provider')) {
                obj['provider'] = UserProviderInfo.constructFromObject(data['provider']);
            }
            if (data.hasOwnProperty('stackhawkId')) {
                obj['stackhawkId'] = ApiClient.convertToType(data['stackhawkId'], 'String');
            }
        }
        return obj;
    }
