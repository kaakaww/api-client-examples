    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('defaultOrganizationId')) {
                obj['defaultOrganizationId'] = ApiClient.convertToType(data['defaultOrganizationId'], 'String');
            }
            if (data.hasOwnProperty('dontReceiveUpdatesEmail')) {
                obj['dontReceiveUpdatesEmail'] = ApiClient.convertToType(data['dontReceiveUpdatesEmail'], 'Boolean');
            }
            if (data.hasOwnProperty('dontReceiveWeeklyEmail')) {
                obj['dontReceiveWeeklyEmail'] = ApiClient.convertToType(data['dontReceiveWeeklyEmail'], 'Boolean');
            }
        }
        return obj;
    }
...
export default UserUserPreferences;
